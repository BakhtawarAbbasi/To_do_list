...
let todos = [];
let condition = true;
console.log(chalk.bgMagenta.bold(`              W   E   L   C   O   M   E     T   O                `));
console.log(chalk.bgCyanBright.bold(`         B  A  K  H  T  A  W  A  R                    `));
console.log(chalk.bgMagenta.bold(`            T   O        D   O       L   I   S   T                  `));
